...
const { getClients, getClientById, getClientSummary, createClient, updateClient, deleteClient, checkDuplicateClient } = require('../controllers/clientController');
...
router.get('/:id/summary', authenticate, getClientSummary);
