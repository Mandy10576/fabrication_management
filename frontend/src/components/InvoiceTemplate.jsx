      ...
      <div>
        ...
        <div className="border-t border-b border-slate-300 py-2 my-3 text-center" style={{ borderTop: '1px solid #cbd5e1', borderBottom: '1px solid #cbd5e1', paddingTop: '6px', paddingBottom: '6px', marginTop: '12px', marginBottom: '12px', textAlign: 'center' }}>
          {invoice.gstType === 'NON_GST' ? (
            ...
            <h2 className="text-sm font-extrabold uppercase" style={{ color: '#4c40aa', fontSize: '15px', fontWeight: '800', letterSpacing: '0.25em', margin: 0 }}>
              T A X &nbsp;&nbsp;&nbsp; I N V O I C E
            </h2>
          )}
        </div>
        ...
        <div className="mb-4" style={{ marginBottom: '16px' }}>
          <table className="w-full text-left border-collapse" style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
            <thead>
              <tr style={{ backgroundColor: '#4c40aa', color: '#ffffff', fontWeight: '700', fontSize: '10.5px', textTransform: 'uppercase', borderRadius: '4px' }}>
